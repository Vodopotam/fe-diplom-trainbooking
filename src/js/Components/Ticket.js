      ...
      <div className="ticket">
        <div className="train-info">
          ...
          <div className="train-info__direction">
            <span className="train-info__direction-left">Адлер &#8594;</span>
            <br />
            Москва &#8594;
            <br /> Санкт-Петербург
          </div>
        ...
        <div className="time-info">
          <div className="time-info__direction-to">
            <div className="time-info__departure">
              ...
              <div className="time-info__departure-station">Курский вокзал</div>
            </div>
            ...
            <div className="time-info__arrival">
              ...
              <div className="time-info__arrival-city">Санкт-Петербург</div>
              <div className="time-info__arrival-station">Ладожский вокзал</div>
            </div>
          </div>
          ...
          <ul className="coaches">
            <li className="coaches__sitting coaches_type">
              ...
              <div className="coaches__price">
                от <span className="coaches__price-number">1920</span>{' '}
            ...
            <li className="coaches__reserved coaches_type">
              ...
              <div className="coaches__price">
                от <span className="coaches__price-number">2530</span>{' '}
                <span className="coaches__price-currency">&#x20bd;</span>
              </div>
            </li>
            <li className="coaches__compartment coaches_type">
              ...
              <div className="coaches__price">
                от <span className="coaches__price-number">3820</span>{' '}
                <span className="coaches__price-currency">&#x20bd;</span>
              </div>
            </li>
            <li className="coaches__luxe coaches_type">
              ...
              <div className="coaches__price">
                от <span className="coaches__price-number">4950</span>{' '}
                <span className="coaches__price-currency">&#x20bd;</span>
              </div>
            </li>
          </ul>
