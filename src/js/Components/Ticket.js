...
export const Ticket = (props) => {
    ...
    const durationMinutes = Math.floor(departure.duration / 60) - (durationHours * 60);
    return (
      <div className="ticket">
        <div className="train-info">
          <div className="train-info__number">{departure.train.name}</div>
          <div className="train-info__direction">
            <span className="train-info__direction-left">{departure.from.city.name} &#8594;</span>
            <br />
        ...
        <div className="time-info">
          <div className="time-info__direction-to">
            <div className="time-info__departure">
              <div className="time-info__departure-time">{new Date(departure.from.datetime * 1000).toLocaleTimeString([], {hour: '2-digit', minute: '2-digit'})}</div>
              <div className="time-info__departure-city">{departure.from.city.name}</div>
            ...
            <div className="time-info__arrival">
              <div className="time-info__arrival-time">{new Date(departure.to.datetime * 1000).toLocaleTimeString([], {hour: '2-digit', minute: '2-digit'})}</div>
              <div className="time-info__arrival-city">{departure.to.city.name}</div>
        ...
        <div className="coach-choice">
          ...
          {departure.have_fourth_class ?
            (<li className="coaches__sitting coaches_type">
              ...
              <div className="coaches__quantity">{departure.available_seats_info.fourth}</div>
              <div className="coaches__price">
                от <span className="coaches__price-number">{departure.price_info.fourth.bottom_price}</span>{' '}
          ...
          {departure.have_third_class ?
            (<li className="coaches__reserved coaches_type">
              ...
              <div className="coaches__quantity">{departure.available_seats_info.third}</div>
              <div className="coaches__price">
                от <span className="coaches__price-number">{departure.price_info.third.bottom_price}</span>{' '}
                <span className="coaches__price-currency">&#x20bd;</span>
              </div>
            </li>) : null }
            ...
            (<li className="coaches__compartment coaches_type">
              ...
              <div className="coaches__quantity">{departure.available_seats_info.second}</div>
              <div className="coaches__price">
                от <span className="coaches__price-number">{departure.price_info.second.bottom_price}</span>{' '}
                <span className="coaches__price-currency">&#x20bd;</span>
              </div>
            </li>) : null}
            ...
            (<li className="coaches__luxe coaches_type">
              ...
              <div className="coaches__quantity">{departure.available_seats_info.first}</div>
              <div className="coaches__price">
                от <span className="coaches__price-number">{departure.price_info.first.bottom_price}</span>{' '}
                <span className="coaches__price-currency">&#x20bd;</span>
              </div>
            </li>) : null}
          </ul>
          ...
          <ul className="ticket-options"> 
            <li className={`ticket-options__wifi ${departure.have_wifi ? 'active' : ''}`}></li>
            <li className={`ticket-options__speed ${departure.is_express ? 'active' : ''}`}></li>
            <li className={`ticket-options__comfort ${departure.have_air_conditioning ? 'active' : ''}`}></li>
          </ul>
