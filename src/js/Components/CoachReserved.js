  ...
  handleClick = e => {
    if (
      ...
      this.props.setTotalPrice(
        -this.props.current.coach.top_price,
        ...
        <div className="coach-description">
          ...
          <div className="coach-description__places">
            ...
            <p className="coach-description__places-top">
              Верхние
              <span className="coach-description__places-top-number">
                {' '}
                {Math.ceil(current.coach.available_seats / 2)}
              </span>
            </p>
          ...
          <div className="train-image">
            ...
            <div className="train-image__places">
              {current.seats.map(seat => (
                <div
                  key={seat.index}
                  className={`place place${seat.index} ${
